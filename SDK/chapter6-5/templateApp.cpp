...
unsigned char restart_game = 0, // Flag to restart the game.
              momo_launch  = 0, // Flag to let momo be thrown.
              banana       = 0; // Banana counter.
...
void templateAppDraw( void ) {
     ...
     * Finally, reset the restart_game flag back to 0 to avoid loading again and
     * again if the flag is raised.
     */
    if( restart_game ) {
        templateAppExit();
