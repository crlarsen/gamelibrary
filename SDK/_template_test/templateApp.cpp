...
void templateAppInit( int width, int height )
{
	...
	console_print( "templateAppInit, screen size: %dx%d\n", width, height );
}
...
void templateAppToucheBegan( float x, float y, unsigned int tap_count )
{
	...
	console_print( "templateAppToucheBegan, touche: %f,%f tap: %d\n", x, y, tap_count );
}
...
void templateAppToucheMoved( float x, float y, unsigned int tap_count )
{
	...
	console_print( "templateAppToucheMoved, touche: %f,%f tap: %d\n", x, y, tap_count );
}
...
void templateAppToucheEnded( float x, float y, unsigned int tap_count )
{
	...
	console_print( "templateAppToucheEnded, touche: %f,%f tap: %d\n", x, y, tap_count );
}
